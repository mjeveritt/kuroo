 ...
 * @param packageList
 */
void Updates::pretendPackage( const QString& category, const QStringList& packageList )
{
 ...
 * @param category
 */
void Updates::pretendPackage( const QStringList& packageList )
{
	EmergeSingleton::Instance()->pretend( packageList );
}

/**
 * Get list of all categories for update packages.
 * @return QStringList
 */
QStringList Updates::categories()
{
	return KurooDBSingleton::Instance()->updatesCategories();
}
 ...
 * @return QStringList
 */
QStringList Updates::packagesInCategory( const QString& category )
{
	QString idCategory = KurooDBSingleton::Instance()->portageCategoryId(category).first();
	return KurooDBSingleton::Instance()->updatesPackagesByCategory(idCategory);
}

/**
 * Get list of all update packages.
 * @return QStringList
 */
QStringList Updates::allPackages()
{
	return KurooDBSingleton::Instance()->updatesPackages();
}
