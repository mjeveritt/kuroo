...
QueueListView2::QueueListView2(QWidget *parent)
 : QTreeView(parent)
{
...
QueueListView2::~QueueListView2()
{}

void QueueListView2::selectionChanged(const QItemSelection& selected, const QItemSelection& deselected)
{
...
QList<QueueListItem*> QueueListView2::selectedPackages() const
{
	return m_selectedPackages;
}

QueueListItem* QueueListView2::currentPackage()
{
	return dynamic_cast<QueueListModel*>(model())->packages().at(currentIndex().row());
}

QueueListItem* QueueListView2::packageItemById(const QString& id)
{
	return m_packageIndex[id];
}

QStringList QueueListView2::selectedPackagesByIds()
{
	QStringList ret;
 ...
 */
void QueueListView2::insertPackageList( bool hasCheckedQueue )
{
	QueueListItem* item;
 ...
 */
long QueueListView2::totalDuration()
{
	long totalSeconds = 0;
	//TODO:Implement me
 ...
 * @return packageList
 */
const QStringList QueueListView2::allPackagesNoChildren()
{
...
const QStringList QueueListView2::allId() const
{
	QStringList idList;
	//TODO:impement me!
...
void QueueListView2::nextPackage( const bool& isPrevious )
{
	//TODO:implement me!
	/*
	if ( isVisible() ) {
 ...
 */
const QString QueueListView2::formatSize( const QString& sizeString )
{
 ...
 * @param size
 */
void QueueListView2::addSize( const QString& size )
{
 ...
 * @param item
 */
void QueueListView2::indexPackage( const QString& id, QueueListItem *item )
{
	if ( !id.isEmpty() ) {
