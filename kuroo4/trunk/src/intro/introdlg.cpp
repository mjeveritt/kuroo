...
IntroDlg::IntroDlg( QWidget* parent )
{
	...
	QString backupFilesText = QString("<qt><table width=100%><tr><td>Make copies into %1 of following files:</td></tr>").arg(kurooDir + "backup/");
	...
	backupFiles->setText( i18n(backupFilesText));
	adjustSize();
}
