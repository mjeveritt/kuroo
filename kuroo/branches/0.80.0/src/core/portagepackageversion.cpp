...
bool PortagePackageVersion::isNewerThan( const QString& otherVersion ) const
{
	...
	thatSuffix = PortagePackageVersion::suffixNumber( otherVersion, &suffixPos );
...
*              (e.g. "x86" or "~alpha").
*/
PortagePackageVersion::Stability PortagePackageVersion::stability( const QString& arch ) const
{
...
*/
int PortagePackageVersion::revisionNumber( const QString& versionString, int* foundPos ) const
{
...
*/
long PortagePackageVersion::suffixNumber( const QString& versionString, int* foundPos ) const
{
...
*           or 0 if no revision has been found.
*/
int PortagePackageVersion::trailingCharNumber( const QString& versionString, int* foundPos ) const
{
...
* @see description
*/
void PortagePackageVersion::setVersion( const QString& version )
{
	m_version = version;
}
